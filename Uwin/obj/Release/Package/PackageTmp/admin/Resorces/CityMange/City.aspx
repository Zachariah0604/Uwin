<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="City.aspx.cs" Inherits="Uwin.admin.Resorces.CityMange.City" %>
...
<body>
    ...
    <div>
        ...
        <asp:Repeater runat="server" ID="CityRepeter">
            <HeaderTemplate>
            ...
            <table id="mytable" cellspacing="2" summary="The technical specifications of the Apple PowerMac G5 series">
                <tr>
                    <td width="20%"><asp:CheckBox CssClass="checkall" ID="CityCheck" runat="server" /></td>
                    ...
                    <td width="40%"><a href="Area.aspx?code=<%#Eval("code") %>"><%#Eval("name") %></a></td>
