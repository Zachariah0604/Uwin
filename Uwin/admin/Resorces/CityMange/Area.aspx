<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Area.aspx.cs" Inherits="Uwin.admin.Resorces.CityMange.Area" %>
...
<body>
    ...
    <div>
        <div class="navi"><span class="option"><a href="Add.aspx">新增</a></span><span class="posi"><b>当前位置：<asp:SiteMapPath ID="SiteMapPath1" runat="server"></asp:SiteMapPath> </b></div>
        <asp:Repeater runat="server" ID="AreaRepeter">
            <HeaderTemplate>
            ...
            <table id="mytable" cellspacing="2" summary="The technical specifications of the Apple PowerMac G5 series">
                <tr>
                    <td width="20%"><asp:CheckBox CssClass="checkall" ID="AreaCheck" runat="server" /></td>
                    ...
                    <td width="40%"><asp:Label ID="name" runat="server" Text='<%#Eval("name") %>'></asp:Label></td>
